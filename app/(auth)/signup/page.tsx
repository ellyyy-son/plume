...
export default async function Signup() {
  ...
  <label htmlFor="name" className="block font-delius text-xl/6 font-bold text-[#2E2805] basis-1/3">Name</label>    
   <div className="rounded-t-md bg-white opacity-70 px-3 py-1 basis-2/3 border-b-3 border-[#CCC38D] focus-within:border-[#ADD3EA]">
              <input id="name" type="text" name="name" placeholder="name" className="font-delius block min-w-0 grow bg-transparent py-1.5 pr-3 pl-1 text-base text-[#2E2805] placeholder:text-[#CCC38D] focus:outline-none sm:text-sm/6" />
          </div></div>
   {/* username text area */}
    <div className="flex place-content-between w-1/1 py-4">
      <label htmlFor="username" className="block font-delius text-xl/6 font-bold text-[#2E2805] basis-1/3">Username</label>    
        <div className="rounded-t-md bg-white opacity-70 px-3 py-1 basis-2/3 border-b-3 border-[#CCC38D] focus-within:border-[#F0B6CF]">
              <input id="username" type="text" name="username" placeholder="username" className="block font-delius min-w-0 grow bg-transparent py-1.5 pr-3 pl-1 text-base text-[#2E2805] placeholder:text-[#CCC38D] focus:outline-none sm:text-sm/6" />
          </div>
    </div>
    {/* e-mail text area */}
    <div className="flex place-content-between w-1/1 py-4">
      <label htmlFor="e-mail" className="block font-delius text-xl/6 font-bold text-[#2E2805] basis-1/3">E-mail</label>    
        <div className="rounded-t-md bg-white opacity-70 px-3 py-1 basis-2/3 border-b-3 border-[#CCC38D] focus-within:border-[#F0B6CF]">
              <input id="e-mail" type="text" name="e-mail" placeholder="e-mail" className="block font-delius min-w-0 grow bg-transparent py-1.5 pr-3 pl-1 text-base text-[#2E2805] placeholder:text-[#CCC38D] focus:outline-none sm:text-sm/6" />
          </div>
    </div>
    {/* password text area */}
    <div className="flex place-content-between w-1/1 py-4">
      <label htmlFor="password" className="block font-delius text-xl/6 font-bold text-[#2E2805] basis-1/3">Password</label>    
        <div className="rounded-t-md bg-white opacity-70 px-3 py-1 basis-2/3 border-b-3 border-[#CCC38D] focus-within:border-[#F0B6CF]">
              <input id="password" type="text" name="password" placeholder="password" className="block font-delius min-w-0 grow bg-transparent py-1.5 pr-3 pl-1 text-base text-[#2E2805] placeholder:text-[#CCC38D] focus:outline-none sm:text-sm/6" />
          </div>
    </div>
    {/* buttons */}
